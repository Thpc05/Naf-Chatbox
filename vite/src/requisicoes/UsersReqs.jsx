export async function updUserDB (user) {
    ...
    console.log(user);
    try {
            const response = await fetch('https://nafchatboxserver.vercel.app/db/register/updUser', {
                method: 'POST',
                headers: {
...
export async function getAllUsersDB () {
    ...
    try {
        const response = await fetch('https://nafchatboxserver.vercel.app/db/register/getAllUsers', {
            method: 'GET',
            headers: {
           'Content-Type': 'application/json'
            }
